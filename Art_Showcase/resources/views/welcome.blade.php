...
@section('content')
    ...
    <div class="p-5 mb-5 text-center hero-jumbotron text-white rounded-3 shadow-lg">
...
<div class="masonry-grid">
    @forelse ($artworks->take(8) as $artwork)
        <div class="masonry-item"> 
            <a href="{{ route('artworks.show', $artwork) }}" class="text-decoration-none text-dark d-block">
                {{-- 💡 PERBAIKAN: Hapus onmouseover/onmouseout yang kompleks --}}
...
<div class="row">
    @forelse ($challenges as $challenge)
        <div class="col-md-4 mb-4">
            {{-- 💡 PERBAIKAN: Tambahkan style hover yang disederhanakan --}}
